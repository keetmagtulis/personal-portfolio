...
- **Frameworks and Libraries:** Rasa, React, Node.js
- **Tools and Technologies:** Git, Docker, SQL
- **Networking:** Network configuration, troubleshooting, and management
- **Active Directory Management:** User and group management, policy configuration
- **Administration:** System administration, server maintenance, software installation
- **Soft Skills:** Problem-solving, teamwork, communication

## Education

- **Bachelor of Science in Computer Science**
  - Iloilo Science and Technology University, S.Y. 2021-2022
...
- **Customer Service Support (BPO)**
  - WNS, September 2022 - Febuary 2023
