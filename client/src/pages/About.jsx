...
const [selectedId, setSelectedId] = useState(null);
    ...
    <div className="flex justify-center items-center min-h-screen" id="about">
        ...
        {/* AnimatePresence to show selected item */}
        <AnimatePresence>
        {selectedId && (
          <motion.div
            layoutId={selectedId}
            className="fixed inset-0 bg-white p-10 flex flex-col items-center justify-center rounded-md shadow-lg w-10/12 h-3/4 lg:w-1/2 max-w-xl mx-auto my-auto"
          >
